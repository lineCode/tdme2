...
void PhysicsTest3::initialize()
{
	...
	(*sideModel->getMaterials())["tdme.primitive.material"]->setAmbientColor(Color4(0.4f, 0.4f, 0.4f, 1.0f));
	(*sideModel->getMaterials())["tdme.primitive.material"]->setDiffuseColor(Color4(0.5f, 0.5f, 0.5f, 1.0f));
	...
	(*nearFarModel->getMaterials())["tdme.primitive.material"]->setAmbientColor(Color4(0.4f, 0.4f, 0.4f, 1.0f));
	(*nearFarModel->getMaterials())["tdme.primitive.material"]->setDiffuseColor(Color4(0.5f, 0.5f, 0.5f, 1.0f));
	...
	(*sphereModel->getMaterials())["tdme.primitive.material"]->setAmbientColor(Color4(0.25f, 0.4f, 0.4f, 1.0f));
	(*sphereModel->getMaterials())["tdme.primitive.material"]->setDiffuseColor(Color4(0.0f, 0.5f, 0.5f, 1.0f));
	...
	(*capsuleModel->getMaterials())["tdme.primitive.material"]->setAmbientColor(Color4(0.4f, 0.0f, 0.4f, 1.0f));
	(*capsuleModel->getMaterials())["tdme.primitive.material"]->setDiffuseColor(Color4(0.5f, 0.0f, 0.5f, 1.0f));
	...
	(*capsuleBigModel->getMaterials())["tdme.primitive.material"]->setAmbientColor(Color4(0.5f, 0.4f, 0.4f, 1.0f));
	(*capsuleBigModel->getMaterials())["tdme.primitive.material"]->setDiffuseColor(Color4(0.5f, 0.0f, 0.0f, 1.0f));
